...
function asAmirror(frase) {
   ...
   for(let i = 0; i < nuevaFrase.length; i++){
      if(i !== 0) espejo += ' ' + nuevaFrase[i].split('').reverse().join('')
      else espejo += nuevaFrase[i].split('').reverse().join('')
   }
   return espejo;
...
nuevaString = nuevaString + num[i];
   }
   if(nuevaString == numero)
   return"Es capicua";
   else
   ...
   for (let i = 0; i < arrayOfStrings.length; i++){
      for (let j = i + 1; j < arrayOfStrings.length; j++){
         if(arrayOfStrings[i].length > arrayOfStrings[j].length){
            let nuevoArray =  arrayOfStrings[i]
            arrayOfStrings[i] =  arrayOfStrings[j]
            arrayOfStrings[j] = nuevoArray
         }
      }
   }
